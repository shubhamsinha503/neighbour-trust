...
const en: Dict = {
  ...
  "home.title": "Find a neighbourhood that feels right.",
  "home.popularNear": "Popular near you",
  "home.viewAll": "View all",
  "home.exploreByCategory": "Explore by category",
  "cat.healthcare": "Healthcare",
  "cat.green_spaces": "Green spaces",
  "cat.sun": "Sun & shadow",
  ...
  "nav.saved": "Saved",
  "nav.more": "More",
  "search.title": "Explore localities",
  ...
  "overview.tabNearby": "Nearby",
  "overview.tabSun": "Sun & shadow",
  "overview.categories": "Category scores",
  "overview.highlights": "Key highlights",
  "overview.consider": "Things to consider",
  "overview.compare": "Compare",
  "overview.viewMap": "View map",
  "compare.title": "Compare localities",
  "compare.add": "Add locality",
  "compare.empty": "Add up to three localities to compare their scores side by side.",
  "compare.pick": "Choose a locality",
  "compare.trust": "Trust score",
  "compare.full": "You can compare up to three.",
  "hl.strong": "{cat} scores well ({n})",
  "hl.hospitals": "Hospitals within easy reach",
  "hl.parks": "Parks and green spaces nearby",
